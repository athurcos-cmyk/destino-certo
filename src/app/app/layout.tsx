...
const navItems = [
  { href: "/app", label: "Meus Roteiros", icon: MapPin },
  { href: "/app/roteiro/novo", label: "Novo Roteiro", icon: Plus },
  { href: "/app/configuracoes", label: "Configurações", icon: User },
];
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* Bottom nav - mobile */}
        <nav className="md:hidden flex items-center justify-around h-16 border-t bg-background">
          {navItems.map((item) => {
            const isActive =
              item.href === "/app"
                ? pathname === "/app"
